module.exports = {
  ...
  $setGlobalUserVar[coin;$sub[$getGlobalUserVar[coin];$message[1]];$authorID]
  $else
  Tebrikler! kazandınız. $message kadar coin size eklendi
  $setGlobalUserVar[coin;$sum[$getGlobalUserVar[coin];$message];$authorID]
  $endif
  ...
  $onlyIf[$getUserVar[coin]>$message;o kadar paran yok!]   
